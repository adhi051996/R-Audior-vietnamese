    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        mImgSource.setOnImageChangedListener(new FilterImageView.OnImageChangedListener() {
            ...
            public void onBitmapLoaded(@Nullable Bitmap sourceBitmap) {
                ...
                Log.e("CCCFFF", "onBitmapLoaded() called with: sourceBitmapsss = [" + sourceBitmap + "]");

//                Log.e("KKKKHHHDDD","before");
//                if (sourceBitmap!=null) {
//
//                    Log.e("KKKKHHHDDD","entered");
//                    ByteArrayOutputStream stream_1 = new ByteArrayOutputStream();
//                    sourceBitmap.compress(Bitmap.CompressFormat.PNG, 100, stream_1);
//                    bytes_et1 = stream_1.toByteArray();
//
//Log.e("KKKKHHHDDD","bytes = "+bytes_et1);
//                }else{
//
//                    Log.e("KKKKHHHDDD","else");
//                }
//
