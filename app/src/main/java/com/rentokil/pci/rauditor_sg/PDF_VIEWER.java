...
import com.rentokil.pci.rauditor_sg.Adapter.ListViewAdapter_PDF;
import com.rentokil.pci.rauditor_sg.Adapter.List_Item_PDF_Methodes;
...
//        myspin10.setAdapter(dataAdapter);
    ...
    private void get_all_pdf(){
        ...
        String  url="https://rauditor-sg.riflows.com/rAuditor/Android/PDF/ia_completed.php?mail_id=" + User_Details + "" ;
