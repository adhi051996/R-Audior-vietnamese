...
public class FSV_STANDARD_ITEM_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fsv__standard__item_5);
        ...
        db = new DatabaseHelper(FSV_STANDARD_ITEM_5.this);
        ...
        back_title_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i= new Intent(FSV_STANDARD_ITEM_5.this, FSV_STANDARD_TOOL_4.class);
    ...
    public  void insert_offline(){
        ...
        if(get_rd22.equalsIgnoreCase("No")){
            counter_NO++;
        }
        ...
        if(get_rd22.equalsIgnoreCase("N/A")){
            counter_NA++;
        }

        Log.e("LLJJHHYTRW","count no = "+counter_NO);
        Log.e("LLJJHHYTRW","count na = "+counter_NA);
        ...
        if (check_data(key_id) == 0) {
            ...
            sd.insert(db.FSV_STAND_ITEM_5, null, cv_off);
            cv_off.clear();

            Intent intent = new Intent(FSV_STANDARD_ITEM_5.this, FSV_EMERGENCY_6.class);
            ...
            Log.e("JJJJDDD", "e2");
            sd.update(db.FSV_STAND_ITEM_5,  cv_off,"KEY_ID = '" + key_id + "'",null);
            cv_off.clear();
    ...
    public void get_offline(String id){
        ...
        Log.e("GGGRRRR","E2"  + id);
        String Query="select * from "+db.FSV_STAND_ITEM_5 +" where KEY_ID = '"+id+"'";
        Cursor cursor = sd.rawQuery(Query, null);
        cursor.moveToFirst();
...
/////////////////////rd21//////////
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.vir_home:
                Intent sir_home = new Intent(FSV_STANDARD_ITEM_5.this, Category_Type_Activity.class);
                sir_home.putExtra("key_id", key_id);
                startActivity(sir_home);
                break;
            case R.id.vir_title_page_1:
                if (key_id != null) {
                    Intent sir_customer = new Intent(FSV_STANDARD_ITEM_5.this, PC_VIR_TITLE_1.class);
            ...
            case R.id.vir_body_2:
                if (key_id != null) {
                    Intent sir_customer = new Intent(FSV_STANDARD_ITEM_5.this, PC_VIR_BODY_2.class);
                    sir_customer.putExtra("key_id", key_id);
                    startActivity(sir_customer);
                } else {
                }
            ...
            case R.id.vir_funct_3:
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_STANDARD_ITEM_5.this, PC_VIR_FUNCTION_3.class);
            ...
            case R.id.vir_gen_4:
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_STANDARD_ITEM_5.this, PC_VIR_GENERAL_4.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
            ...
            case R.id.vir_ppe_5:
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_STANDARD_ITEM_5.this, PC_VIR_PPE_5.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
            ...
            case R.id.vir_other_7:
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_STANDARD_ITEM_5.this, PC_VIR_OTHER_7.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
