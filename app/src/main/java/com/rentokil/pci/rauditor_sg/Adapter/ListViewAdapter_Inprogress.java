...
public class ListViewAdapter_Inprogress extends BaseAdapter {
    ...
    private List<com.rentokil.pci.rauditor_sg.Adapter.List_Item_Methodes_incomplete> List_Item_Methodes_incomplete = null;
    private ArrayList<com.rentokil.pci.rauditor_sg.Adapter.List_Item_Methodes_incomplete> arraylist;
    public ListViewAdapter_Inprogress(Context context, ArrayList<com.rentokil.pci.rauditor_sg.Adapter.List_Item_Methodes_incomplete> List_Item_Methodes_incomplete) {
        mContext = context;
        this.List_Item_Methodes_incomplete = List_Item_Methodes_incomplete;
        inflater = LayoutInflater.from(mContext);
        this.arraylist = new ArrayList<com.rentokil.pci.rauditor_sg.Adapter.List_Item_Methodes_incomplete>();
...
/*
    ...
    public void filter(String charText) {
        ...
        if (charText.length() == 0) {
            ...
            for (com.rentokil.pci.rauditor_sg.Adapter.List_Item_Methodes_incomplete wp : arraylist) {
