package com.rentokil.pci.rauditor_sg.Multiple_Image;
...
public class Pmca_GalleryAdapter extends BaseAdapter {
    ...
    public Pmca_GalleryAdapter(Context ctx, ArrayList<Uri> mArrayUri) {
        this.ctx = ctx;
