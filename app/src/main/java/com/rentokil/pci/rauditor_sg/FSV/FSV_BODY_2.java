...
String get_remarks;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedImagesContainer1.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                Toast.makeText(FSV_BODY_2.this, ""+position, Toast.LENGTH_SHORT).show();
        ...
        image_Q1.setOnClickListener(view -> {
            PermissionListener permissionlistener = new PermissionListener() {
                ...
                public void onPermissionGranted() {
                    ...
                    multiImageDisposable1 = TedRxBottomPicker.with(FSV_BODY_2.this)
        ...
        image_Q2.setOnClickListener(view -> {
            PermissionListener permissionlistener = new PermissionListener() {
                ...
                public void onPermissionGranted() {
                    ...
                    multiImageDisposable2 = TedRxBottomPicker.with(FSV_BODY_2.this)
                            //.setPeekHeight(getResources().getDisplayMetrics().heightPixels/2)
                            .setPeekHeight(1600)
                            .showTitle(false)
                            .setCompleteButtonText("Done")
        ...
        image_Q3.setOnClickListener(view -> {
            PermissionListener permissionlistener = new PermissionListener() {
                ...
                public void onPermissionGranted() {
                    ...
                    multiImageDisposable3 = TedRxBottomPicker.with(FSV_BODY_2.this)
                            //.setPeekHeight(getResources().getDisplayMetrics().heightPixels/2)
                            .setPeekHeight(1600)
                            .showTitle(false)
                            .setCompleteButtonText("Done")
        ...
        image_Q4.setOnClickListener(view -> {
            PermissionListener permissionlistener = new PermissionListener() {
                ...
                public void onPermissionGranted() {
                    ...
                    multiImageDisposable4 = TedRxBottomPicker.with(FSV_BODY_2.this)
                            //.setPeekHeight(getResources().getDisplayMetrics().heightPixels/2)
                            .setPeekHeight(1600)
                            .showTitle(false)
                            .setCompleteButtonText("Done")
    ...
    public int check_data(String key_id){
        String Query="select * from "+db.FSV_DB_BODY_2 +" where KEY_ID = '"+key_id+"'";
    ...
    public void get_offline(String id){
        ...
        Log.e("GGGRRRR","E2"  + id);
        String Query="select * from "+db.FSV_DB_BODY_2 +" where KEY_ID = '"+id+"'";
        Cursor cursor = sd.rawQuery(Query, null);
        cursor.moveToFirst();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.vir_title_page_1:
                if (key_id != null) {
                    Intent sir_customer = new Intent(FSV_BODY_2.this, PC_VIR_TITLE_1.class);
            ...
            case R.id.vir_funct_3:
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_BODY_2.this, PC_VIR_FUNCTION_3.class);
            ...
            case R.id.vir_gen_4:
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_BODY_2.this, PC_VIR_GENERAL_4.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
            ...
            case R.id.vir_ppe_5:
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_BODY_2.this, PC_VIR_PPE_5.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
            ...
            case R.id.vir_stan_6:
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_BODY_2.this, PC_VIR_STANDARD_6.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
            ...
            case R.id.vir_other_7:
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_BODY_2.this, PC_VIR_OTHER_7.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
