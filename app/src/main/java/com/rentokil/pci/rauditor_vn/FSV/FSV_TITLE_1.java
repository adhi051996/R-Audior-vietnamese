    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.vir_body_2:
                if (key_id != null) {
                    Intent sir_customer = new Intent(FSV_TITLE_1.this, FSV_BODY_2.class);
            ...
            case R.id.vir_funct_3:
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_TITLE_1.this, FSV_GENERAL_3.class);
                ...
                case R.id.vir_gen_4:
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_TITLE_1.this, FSV_STANDARD_TOOL_4.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                ...
                case R.id.vir_ppe_5:
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_TITLE_1.this, FSV_STANDARD_ITEM_5.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
                ...
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_TITLE_1.this, FSV_EMERGENCY_6.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
                ...
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_TITLE_1.this, FSV_SIGN_7.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
