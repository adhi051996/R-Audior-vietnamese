...
public class PC_VIR_FUNCTION_3 extends AppCompatActivity {
    ...
    private  double PC_VIR_3_counter_FAIR_1=0.0;
    private  double PC_VIR_3_counter_FAIR_2=0.0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("HAHAXBXBBXBX","3 key_id  = "+key_id);
    ...
    private void insert_offline(String Status) {
        ...
        try {
            ...
            if(get_rd1.equalsIgnoreCase("Pass")){
                PC_VIR_3_counter_PASS++;
            }
            else if (get_rd1.equalsIgnoreCase("Fail")){
                PC_VIR_3_counter_FAIL++;
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        try {
            ...
            if(get_rd2.equalsIgnoreCase("Pass")){
                PC_VIR_3_counter_PASS++;
            }
            else if (get_rd2.equalsIgnoreCase("Fail")){
                PC_VIR_3_counter_FAIL++;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            if(get_rd5.equalsIgnoreCase("Pass")){
                PC_VIR_3_counter_PASS++;
            }
            else if (get_rd5.equalsIgnoreCase("Fail")){
                PC_VIR_3_counter_FAIL++;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            if(get_rd7.equalsIgnoreCase("Pass")){
                PC_VIR_3_counter_PASS++;
            }
            else if (get_rd7.equalsIgnoreCase("Fail")){
                PC_VIR_3_counter_FAIL++;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            if(get_rd8.equalsIgnoreCase("Pass")){
                PC_VIR_3_counter_PASS++;
            }
            else if (get_rd8.equalsIgnoreCase("Fail")){
                PC_VIR_3_counter_FAIL++;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            if(get_rd9.equalsIgnoreCase("Pass")){
                PC_VIR_3_counter_PASS++;
            }
            else if (get_rd9.equalsIgnoreCase("Fail")){
                PC_VIR_3_counter_FAIL++;
            }
        ...
        try {
            ...
            if(get_rd10.equalsIgnoreCase("Good")){
                PC_VIR_3_counter_PASS++;
            }
            else if (get_rd10.equalsIgnoreCase("Fair")){


                PC_VIR_3_counter_FAIR_1++;

                Log.e("AASXCVAA","before = "+PC_VIR_3_counter_FAIR_1);

                PC_VIR_3_counter_FAIR_1 = PC_VIR_3_counter_FAIR_1 / 2;



                Log.e("AASXCVAA","afters 2= "+PC_VIR_3_counter_FAIR_1);
            }
            else if (get_rd10.equalsIgnoreCase("Poor")){
                PC_VIR_3_counter_FAIL++;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            if(get_rd11.equalsIgnoreCase("Good")){
                PC_VIR_3_counter_PASS++;
            }
            else if (get_rd11.equalsIgnoreCase("Fair")){


                PC_VIR_3_counter_FAIR_2++;

                Log.e("AASXCVAA","before = "+PC_VIR_3_counter_FAIR_2);

                PC_VIR_3_counter_FAIR_2 = PC_VIR_3_counter_FAIR_2 / 2;



                Log.e("AASXCVAA","afters 2 = "+PC_VIR_3_counter_FAIR_2);
            }
            else if (get_rd11.equalsIgnoreCase("Poor")){
                PC_VIR_3_counter_FAIL++;
            }

        } catch (Exception e) {

            Log.e("AASXCVAA","error  = "+e.getMessage());
            e.printStackTrace();
        }
        try {
            get_rd12 = ((RadioButton) findViewById(main_rd12.getCheckedRadioButtonId())).getText().toString();

            if(get_rd12.equalsIgnoreCase("Yes")){
                PC_VIR_3_counter_PASS++;
            }
            else if (get_rd12.equalsIgnoreCase("No")){
                PC_VIR_3_counter_FAIL++;
            }
        ...
        try {
            ...
            if(get_rd14.equalsIgnoreCase("Pass")){
                PC_VIR_3_counter_PASS++;
            }
            else if (get_rd14.equalsIgnoreCase("Fail")){
                PC_VIR_3_counter_FAIL++;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        double Fair=PC_VIR_3_counter_FAIR_1+PC_VIR_3_counter_FAIR_2;

        Log.e("AASXCVAAE","Fair total 1 " + PC_VIR_3_counter_FAIR_1);
        Log.e("AASXCVAAE","Fair total 2 " + PC_VIR_3_counter_FAIR_2);
        Log.e("AASXCVAAE","total " + Fair);

        Log.e("AASXCVAAE","Pass =  " + PC_VIR_3_counter_PASS);
        Log.e("AASXCVAAE","fail =  " + PC_VIR_3_counter_FAIL);
        ...
        cv_off.put(db.PASS_CHECK, "" + PC_VIR_3_counter_PASS);
        cv_off.put(db.FAIL_CHECK, "" + PC_VIR_3_counter_FAIL);
        cv_off.put(db.FAIR_CHECK, "" + Fair);
        cv_off.put(db.MAIN_ID, "" + key_id);


Log.e("AAHXHXHXBXBBXBX","check_data = "+check_data(key_id));
Log.e("c","key_id = "+key_id);
        if (check_data(key_id) == 0) {
            Log.e("AAHXHXHXBXBBXBX", "enter");
    ...
    public void get_offline(String id){
        ...
        Log.e("GGGRRRR","E2"  + id);
        String Query="select * from "+db.PC_VIR_DB_FUNCTION_3 +" where MAIN_ID = '"+id+"'";
        Cursor cursor = sd.rawQuery(Query, null);
        cursor.moveToFirst();
