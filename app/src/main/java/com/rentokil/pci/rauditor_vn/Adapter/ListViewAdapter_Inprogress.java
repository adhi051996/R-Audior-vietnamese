...
public class ListViewAdapter_Inprogress extends BaseAdapter {
    ...
    private List<com.rentokil.pci.rauditor_vn.Adapter.List_Item_Methodes_incomplete> List_Item_Methodes_incomplete = null;
    private ArrayList<com.rentokil.pci.rauditor_vn.Adapter.List_Item_Methodes_incomplete> arraylist;
    public ListViewAdapter_Inprogress(Context context, ArrayList<com.rentokil.pci.rauditor_vn.Adapter.List_Item_Methodes_incomplete> List_Item_Methodes_incomplete) {
        mContext = context;
        this.List_Item_Methodes_incomplete = List_Item_Methodes_incomplete;
        inflater = LayoutInflater.from(mContext);
        this.arraylist = new ArrayList<com.rentokil.pci.rauditor_vn.Adapter.List_Item_Methodes_incomplete>();
...
/* //   public int getCount() {
    ...
    public View getView(final int position, View view, final ViewGroup parent) {
        ...
        holder.count_disp.setText("Pending"/*List_Item_Methodes_incomplete.get(position).getcount_disp()*/);
...
/*
        holder.Bt_Branch.setOnClickListener(new
                                                    ...
                                                    holder.Bt_Tech.setOnClickListener(new
                                                      ...
                                                      public void onClick(View v) {
                                                          ...
                                                          if(List_Item_Methodes_incomplete.get(position).getAudi_name().equalsIgnoreCase("PCI")){
                                                          ...
                                                          if(List_Item_Methodes_incomplete.get(position).getAudi_name().equalsIgnoreCase("FSV")){
                                                              Intent i = new Intent(mContext, FSV_TITLE_1.class);
                                                              i.putExtra("key_id",""+List_Item_Methodes_incomplete.get(position).getId());
                                                              mContext.startActivity(i);
                                                          }

                                                          if(List_Item_Methodes_incomplete.get(position).getAudi_name().equalsIgnoreCase("SI")){
                                                              Intent i = new Intent(mContext, SI_Page_1.class);
                                                              i.putExtra("key_id",""+List_Item_Methodes_incomplete.get(position).getId());
                                                              mContext.startActivity(i);
                                                          }
    ...
    public void filter(String charText) {
        ...
        if (charText.length() == 0) {
            ...
            for (com.rentokil.pci.rauditor_vn.Adapter.List_Item_Methodes_incomplete wp : arraylist) {
