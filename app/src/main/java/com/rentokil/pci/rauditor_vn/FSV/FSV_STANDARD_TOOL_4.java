...
public class FSV_STANDARD_TOOL_4 extends AppCompatActivity {
    ...
    String get_rd1,get_rd2,get_rd3,get_rd4,get_rd5,get_rd6,get_rd7,get_rd8,get_rd9,get_rd10,get_rd11,get_rd12,get_rd13,get_rd14
            ,get_rd15,get_rd16,get_rd17,get_rd18,get_rd19,get_rd20,get_rd21,get_remarks;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fsv__standard_tool_4);
        ...
        db = new DatabaseHelper(FSV_STANDARD_TOOL_4.this);
        ...
        back_title_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i= new Intent(FSV_STANDARD_TOOL_4.this, FSV_GENERAL_3.class);
    ...
    public  void insert_offline(){
        ...
        if(get_rd3.equalsIgnoreCase("No")){
            counter_NO++;
        }
        ...
        if(get_rd6.equalsIgnoreCase("No")){
            counter_NO++;
        }
        ...
        if(get_rd10.equalsIgnoreCase("No")){
            counter_NO++;
        }
        if(get_rd11.equalsIgnoreCase("No")){
            counter_NO++;
        }
        if(get_rd12.equalsIgnoreCase("No")){
            counter_NO++;
        }
        if(get_rd13.equalsIgnoreCase("No")){
            counter_NO++;
        }
        if(get_rd14.equalsIgnoreCase("No")){
            counter_NO++;
        }
        if(get_rd15.equalsIgnoreCase("No")){
            counter_NO++;
        }
        if(get_rd16.equalsIgnoreCase("No")){
            counter_NO++;
        }
        if(get_rd17.equalsIgnoreCase("No")){
            counter_NO++;
        }
        if(get_rd18.equalsIgnoreCase("No")){
            counter_NO++;
        }
        if(get_rd19.equalsIgnoreCase("No")){
            counter_NO++;
        }
        if(get_rd20.equalsIgnoreCase("No")){
            counter_NO++;
        }
        if(get_rd21.equalsIgnoreCase("No")){
            counter_NO++;
        }
        ...
        if(get_rd10.equalsIgnoreCase("N/A")){
            counter_NA++;
        }
        if(get_rd11.equalsIgnoreCase("N/A")){
            counter_NA++;
        }
        if(get_rd12.equalsIgnoreCase("N/A")){
            counter_NA++;
        }
        if(get_rd13.equalsIgnoreCase("N/A")){
            counter_NA++;
        }
        if(get_rd14.equalsIgnoreCase("N/A")){
            counter_NA++;
        }
        if(get_rd15.equalsIgnoreCase("N/A")){
            counter_NA++;
        }
        if(get_rd16.equalsIgnoreCase("N/A")){
            counter_NA++;
        }
        if(get_rd17.equalsIgnoreCase("N/A")){
            counter_NA++;
        }
        if(get_rd18.equalsIgnoreCase("N/A")){
            counter_NA++;
        }
        if(get_rd19.equalsIgnoreCase("N/A")){
            counter_NA++;
        }
        if(get_rd20.equalsIgnoreCase("N/A")){
            counter_NA++;
        }
        if(get_rd21.equalsIgnoreCase("N/A")){
            counter_NA++;
        }

        Log.e("HHGGTRRSEA","count no = "+counter_NO);
        Log.e("HHGGTRRSEA","count na = "+counter_NA);
        ...
        cv_off.put(db.et22, "" + get_remarks);
        cv_off.put(db.NO_COUNT, "" + counter_NO);
        cv_off.put(db.NA_COUNT, "" + counter_NA);

        cv_off.put(db.MAIN_ID, ""+key_id);

        Log.e("AAHHAXHBXBXBXB","check_data = "+check_data(key_id));
        if (check_data(key_id) == 0) {

            sd.insert(db.FSV_STAND_TOOL_4, null, cv_off);
            cv_off.clear();

            Intent intent = new Intent(FSV_STANDARD_TOOL_4.this, FSV_STANDARD_ITEM_5.class);
            ...
            Log.e("JJJJDDD", "e2");
            sd.update(db.FSV_STAND_TOOL_4,  cv_off,"KEY_ID = '" + key_id + "'",null);
            cv_off.clear();
    ...
    public void get_offline(String id){
        ...
        Log.e("GGGRRRR","E2"  + id);
        String Query="select * from "+db.FSV_STAND_TOOL_4 +" where MAIN_ID = '"+id+"'";
        Cursor cursor = sd.rawQuery(Query, null);
        cursor.moveToFirst();
...
/////////////////////rd21//////////
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.vir_home:
                Intent sir_home = new Intent(FSV_STANDARD_TOOL_4.this, Category_Type_Activity.class);
                sir_home.putExtra("key_id", key_id);
                startActivity(sir_home);
                break;
            case R.id.vir_title_page_1:
                if (key_id != null) {
                    Intent sir_customer = new Intent(FSV_STANDARD_TOOL_4.this, FSV_TITLE_1.class);
            ...
            case R.id.vir_body_2:
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_STANDARD_TOOL_4.this, FSV_BODY_2.class);
            ...
            case R.id.vir_funct_3:
                ...
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_STANDARD_TOOL_4.this, FSV_GENERAL_3.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
            ...
            case R.id.vir_ppe_5:
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_STANDARD_TOOL_4.this, FSV_STANDARD_ITEM_5.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
            ...
            case R.id.vir_stan_6:
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_STANDARD_TOOL_4.this, FSV_EMERGENCY_6.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
            ...
            case R.id.vir_other_7:
                if (key_id != null) {
                    Intent sir_observation = new Intent(FSV_STANDARD_TOOL_4.this, FSV_SIGN_7.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
