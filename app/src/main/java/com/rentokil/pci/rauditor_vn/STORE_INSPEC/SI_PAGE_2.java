...
public class SI_PAGE_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.si__page_2);
        ...
        db = new DatabaseHelper(SI_PAGE_2.this);
        ...
        back_title_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i= new Intent(SI_PAGE_2.this, SI_Page_1.class);
    ...
    public  void insert_offline(){
        ...
        if (check_data(key_id) == 0) {
            ...
            sd.insert(db.SI_TITLE_2, null, cv_off);
            cv_off.clear();

            Intent intent = new Intent(SI_PAGE_2.this, SI_PAGE_3.class);
            ...
            Log.e("JJJJDDD", "e2");
            sd.update(db.SI_TITLE_2,  cv_off,"KEY_ID = '" + key_id + "'",null);
            cv_off.clear();
    ...
    public int check_data(String key_id){
        ...
        String Query="select * from "+db.SI_TITLE_2 +" where MAIN_ID = '"+key_id+"'";
    ...
    public void get_offline(String id){
        ...
        Log.e("GGGRRRR","E2"  + id);
        String Query="select * from "+db.SI_TITLE_2 +" where MAIN_ID = '"+id+"'";
        Cursor cursor = sd.rawQuery(Query, null);
        cursor.moveToFirst();
...
/////////////////////rd21//////////
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.si_home:
                Intent sir_home = new Intent(SI_PAGE_2.this, Category_Type_Activity.class);
                sir_home.putExtra("key_id", key_id);
                startActivity(sir_home);
                break;
            case R.id.si_title_page_1:
                if (key_id != null) {
                    Intent sir_customer = new Intent(SI_PAGE_2.this, SI_Page_1.class);
            ...
            case R.id.si_sign_3:
                if (key_id != null) {
                    Intent sir_observation = new Intent(SI_PAGE_2.this, SI_PAGE_3.class);
