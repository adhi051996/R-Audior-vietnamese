...
public class PC_VIR_STANDARD_6 extends AppCompatActivity {
    ...
    private  int PC_VIR_6_counter_PASS=0;
    private  int PC_VIR_6_counter_FAIL=0;
    ...
    public  void insert_offline(){
        try {
            ...
            if(get_rd1.equalsIgnoreCase("Yes")){
                PC_VIR_6_counter_PASS++;
            }
            else if (get_rd1.equalsIgnoreCase("No")){
                PC_VIR_6_counter_FAIL++;
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            if(get_rd11.equalsIgnoreCase("Yes")){
                PC_VIR_6_counter_PASS++;
            }
            else if (get_rd11.equalsIgnoreCase("No")){
                PC_VIR_6_counter_FAIL++;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            if(get_rd21.equalsIgnoreCase("Yes")){
                PC_VIR_6_counter_PASS++;
            }
            else if (get_rd21.equalsIgnoreCase("No")){
                PC_VIR_6_counter_FAIL++;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            if(get_rd22.equalsIgnoreCase("Yes")){
                PC_VIR_6_counter_PASS++;
            }
            else if (get_rd22.equalsIgnoreCase("No")){
                PC_VIR_6_counter_FAIL++;
            }
        ...
        Log.e("AASXCVAAE","Pass6 =  " + PC_VIR_6_counter_PASS);
        Log.e("AASXCVAAE","fail6 =  " + PC_VIR_6_counter_FAIL);
        ...
        cv_off.put(db.PASS_CHECK, "" + PC_VIR_6_counter_PASS);
        cv_off.put(db.FAIL_CHECK, "" + PC_VIR_6_counter_FAIL);
    ...
    public void get_offline(String id){
        ...
        Log.e("GGGRRRR","E2"  + id);
        String Query="select * from "+db.PC_VIR_DB_STANDARD_6 +" where MAIN_ID = '"+id+"'";
        Cursor cursor = sd.rawQuery(Query, null);
        cursor.moveToFirst();
...
/////////////////////rd22//////////
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.vir_home:
                Intent sir_home = new Intent(PC_VIR_STANDARD_6.this, Category_Type_Activity.class);
                sir_home.putExtra("key_id", key_id);
                startActivity(sir_home);
                break;
            case R.id.vir_title_page_1:
                if (key_id != null) {
                    Intent sir_customer = new Intent(PC_VIR_STANDARD_6.this, PC_VIR_TITLE_1.class);
            ...
            case R.id.vir_body_2:
                if (key_id != null) {
                    Intent sir_customer = new Intent(PC_VIR_STANDARD_6.this, PC_VIR_BODY_2.class);
                    sir_customer.putExtra("key_id", key_id);
                    startActivity(sir_customer);
                } else {
                }
            ...
            case R.id.vir_funct_3:
                if (key_id != null) {
                    Intent sir_observation = new Intent(PC_VIR_STANDARD_6.this, PC_VIR_FUNCTION_3.class);
            ...
            case R.id.vir_gen_4:
                if (key_id != null) {
                    Intent sir_observation = new Intent(PC_VIR_STANDARD_6.this, PC_VIR_GENERAL_4.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
            ...
            case R.id.vir_ppe_5:
                if (key_id != null) {
                    Intent sir_observation = new Intent(PC_VIR_STANDARD_6.this, PC_VIR_PPE_5.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
            ...
            case R.id.vir_other_7:
                if (key_id != null) {
                    Intent sir_observation = new Intent(PC_VIR_STANDARD_6.this, PC_VIR_OTHER_7.class);
                    sir_observation.putExtra("key_id", key_id);
                    startActivity(sir_observation);
                } else {
                }
