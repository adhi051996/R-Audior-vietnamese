package com.rentokil.pci.rauditor_vn.Database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String FAIL_CHECK = "FAIL_CHECK";
    public static final String FAIR_CHECK = "FAIR_CHECK";
    ...
    public static final String SI_TITLE_1 = "SI_TITLE_1";
    public static final String SI_TITLE_2 = "SI_TITLE_2";
    public static final String SI_TITLE_3 = "SI_TITLE_3";
    ...
    String CREATE_SI_TITLE_1 = "CREATE TABLE " + SI_TITLE_1 + "(" + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            + MAIN_ID + " INTEGER,"
            + et1 + " TEXT,"
            + et2 + " TEXT,"
            + et3 + " TEXT,"
    ...
    String CREATE_SI_TITLE_2 = "CREATE TABLE " + SI_TITLE_2 + "(" + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            + MAIN_ID + " INTEGER,"
            +et1+" TEXT,"
            +et2+" TEXT,"
            +et3+" TEXT,"
    ...
    String CREATE_SI_TITLE_3 = "CREATE TABLE " + SI_TITLE_3 + "(" + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            + MAIN_ID + " INTEGER,"
            + et1 + " TEXT,"
            + et2 + " TEXT,"
            + CUSTOMER_NAME + " TEXT,"
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(CREATE_SI_TITLE_1);
        db.execSQL(CREATE_SI_TITLE_2);
        db.execSQL(CREATE_SI_TITLE_3);
...
//    }
    ...
    public int get_last_id_SI(SQLiteDatabase sd){
        int last_id=0;
        Cursor c5;
        c5 = sd.rawQuery("Select * from " + SI_TITLE_1, null);
        c5.moveToLast();
        if(c5.getCount()!=0){
            last_id=c5.getInt(c5.getColumnIndex(KEY_ID));
        }
    ...
    public int get_pci_force_completed_count(SQLiteDatabase sd){
        String Status  ="Completed_image";
        String selectQuery = "SELECT * FROM "+PCI_TITLE_1+" where STATUS ='"+Status+"'";
        Cursor cursor = sd.rawQuery(selectQuery, null);
        cursor.moveToFirst();
        cursor.close();
    ...
    public int get_si_completed_count(SQLiteDatabase sd){
        String Status  ="Completed";
        String selectQuery = "SELECT * FROM "+SI_TITLE_1+" where STATUS ='"+Status+"'";
        Cursor cursor = sd.rawQuery(selectQuery, null);
        cursor.moveToFirst();
        cursor.close();
        return cursor.getCount();
