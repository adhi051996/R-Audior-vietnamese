package com.rentokil.pci.rauditor_vn.STORE_INSPEC;
...
public class SI_Page_1 extends AppCompatActivity {

    EditText et_cond_date_2,et_prepared_3,et_loc_4;
    ...
    String get_conduct_date,get_prepared_by,get_location;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.si__page_1);
        ...
        db = new DatabaseHelper(SI_Page_1.this);
        ...
        final LocationManager manager = (LocationManager) SI_Page_1.this.getSystemService(Context.LOCATION_SERVICE);
        if (manager.isProviderEnabled(LocationManager.GPS_PROVIDER) && hasGPSDevice(SI_Page_1.this)) {
//            Toast.makeText(SI_Page_1.this,"Gps already enabled",Toast.LENGTH_SHORT).show();

        }
        // Todo Location Already on  ... end

        if(!hasGPSDevice(SI_Page_1.this)){
            Toast.makeText(SI_Page_1.this,"Gps not Supported",Toast.LENGTH_SHORT).show();
        }

        if (!manager.isProviderEnabled(LocationManager.GPS_PROVIDER) && hasGPSDevice(SI_Page_1.this)) {
            Log.e("keshav","Gps already enabled");
            Toast.makeText(SI_Page_1.this,"Gps not enabled",Toast.LENGTH_SHORT).show();
            enableLoc();
        }else{
            Log.e("keshav","Gps already enabled");
//            Toast.makeText(SI_Page_1.this,"Gps already enabled",Toast.LENGTH_SHORT).show();
        ...
        back_title_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(SI_Page_1.this, Category_Type_Activity.class);
                startActivity(i);
        ...
        getlocations.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                geocoder = new Geocoder(SI_Page_1.this, Locale.getDefault());
                ...
                try {
                    ...
                    if (ContextCompat.checkSelfPermission(mContext,
                            ...
                            != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(SI_Page_1.this,
                                new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);

                    } else {

                        gps = new GPSTracker(mContext, SI_Page_1.this);
    ...
    private void insert_offline(String status){
        ...
        cv_off.put(db.et1, "" + get_location);
        cv_off.put(db.et2, "" + get_prepared_by);
        cv_off.put(db.et3, "" + get_conduct_date);
        ...
        if(check_data(key_id)==0) {
            ...
            sd.insert(db.SI_TITLE_1, null, cv_off);
            Intent intent = new Intent(getApplicationContext(), SI_PAGE_2.class);
            intent.putExtra("key_id", ""+db.get_last_id_SI(sd));
            startActivity(intent);
            Log.e("MMMMMMH","last id = "+db.get_last_id_SI(sd));
        }else {
            Log.e("JJJJJJN","status = "+status);
            sd.update(db.SI_TITLE_1,  cv_off,"KEY_ID = '" + key_id + "'",null);
            Intent intent = new Intent(getApplicationContext(), SI_PAGE_2.class);
...
//        }else {
//            Log.e("HHHHHH","e3");
//            sd.update(db.SI_TITLE_1,  cv_off,"KEY_ID = '" + status + "'",null);
//            Intent intent = new Intent(getApplicationContext(), RIID_GPP_INFOR_2.class);
//            intent.putExtra("key_id", "" + key_id);
//            startActivity(intent);
//
...
//        Cursor c5;
//        c5 = sd.rawQuery("Select * from " + db.SI_TITLE_1, null);
//        c5.moveToFirst();
//
...
//
    ...
    public int check_data(String key_id){
        String Query="select * from "+db.SI_TITLE_1 +" where KEY_ID = '"+key_id+"'";
    ...
    public void get_offline(String id){
        ...
        Log.e("GGGRRRR","E2"  + id);
        String Query="select * from "+db.SI_TITLE_1 +" where KEY_ID = '"+id+"'";
        Cursor cursor = sd.rawQuery(Query, null);
        cursor.moveToFirst();
        ...
        if (cursor.getCount()!=0) {
            ...
            try {
                ...
                et_loc_4.setText(met1);
                et_prepared_3.setText(met2);
                et_cond_date_2.setText(met3);
    ...
    private void enableLoc() {
        ...
        if (googleApiClient == null) {
            googleApiClient = new GoogleApiClient.Builder(SI_Page_1.this)
                    ...
                    switch (status.getStatusCode()) {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            try {
                                ...
                                status.startResolutionForResult(SI_Page_1.this, REQUEST_LOCATION);
    ...
    public void EnableRuntimePermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(SI_Page_1.this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE) && ActivityCompat.shouldShowRequestPermissionRationale(SI_Page_1.this,
                Manifest.permission.READ_EXTERNAL_STORAGE) && ActivityCompat.shouldShowRequestPermissionRationale(SI_Page_1.this,
                Manifest.permission.GET_ACCOUNTS)) {

            Toast.makeText(SI_Page_1.this, "STORAGE and CONTACTS permission allows us to Access the app", Toast.LENGTH_LONG).show();

        } else {

            ActivityCompat.requestPermissions(SI_Page_1.this, new String[]{
    ...
    public boolean validation(){
        ...
        if(TextUtils.isEmpty(get_conduct_date) ||TextUtils.isEmpty(get_prepared_by)
                ||TextUtils.isEmpty(get_location)) {
        ...
        if(get_conduct_date.length()==0||get_prepared_by.length()==0||
                get_location.length()==0){
            return false;
        }else {
            return  true;
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.popup_menu_si, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.si_home:
                Intent sir_home = new Intent(SI_Page_1.this, Category_Type_Activity.class);
                sir_home.putExtra("key_id", key_id);
                startActivity(sir_home);
                break;
            case R.id.si_title_page_1:
                Toast.makeText(getApplicationContext(),"Already,You Are in Same Page",Toast.LENGTH_SHORT).show();
                break;
            case R.id.si_body_2:
                if (key_id != null) {
                    Intent sir_customer = new Intent(SI_Page_1.this, SI_PAGE_2.class);
            ...
            case R.id.si_sign_3:
                if (key_id != null) {
                    Intent sir_observation = new Intent(SI_Page_1.this, SI_PAGE_3.class);
