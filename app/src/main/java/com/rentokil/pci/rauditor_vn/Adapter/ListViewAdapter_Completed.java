...
public class ListViewAdapter_Completed extends BaseAdapter {
    ...
    DatabaseHelper db;
    SQLiteDatabase sd;
    private List<com.rentokil.pci.rauditor_vn.Adapter.List_Item_Methodes> List_Item_Methodes = null;
    private ArrayList<com.rentokil.pci.rauditor_vn.Adapter.List_Item_Methodes> arraylist;

    public static String Image_static;

    public ListViewAdapter_Completed(Context context, ArrayList<com.rentokil.pci.rauditor_vn.Adapter.List_Item_Methodes> List_Item_Methodes) {
        mContext = context;
        this.List_Item_Methodes = List_Item_Methodes;
        inflater = LayoutInflater.from(mContext);
        this.arraylist = new ArrayList<com.rentokil.pci.rauditor_vn.Adapter.List_Item_Methodes>();
        ...
        holder.View_Bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (List_Item_Methodes.get(position).getStatus().equalsIgnoreCase("SENT")||
                    ...
                    builder.setMessage("Hành động - (Xem / Gửi lại)");
                    builder.setCancelable(true);
                    if(List_Item_Methodes.get(position).getStatus().equalsIgnoreCase("SENT")) {
                        builder.setPositiveButton("Gửi lại",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {

                                        Image_static="not_Active";
                                        ...
                                        if (List_Item_Methodes.get(position).getAudi_name().equalsIgnoreCase("SI")) {
                                            holder.View_Bt.setText("NOT SEND");
                                            cv.put(db.STATUS, "Completed");
                                            sd.update(db.SI_TITLE_1, cv, "KEY_ID = '" + List_Item_Methodes.get(position).getId() + "'", null);
                                        }
                    ...
                    builder.setNeutralButton("Buộc gửi lại ", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {



                            Image_static="force_active";
...
//                            }
    ...
    public void filter(String charText) {
        ...
        if (charText.length() == 0) {
            ...
            for (com.rentokil.pci.rauditor_vn.Adapter.List_Item_Methodes wp : arraylist) {
