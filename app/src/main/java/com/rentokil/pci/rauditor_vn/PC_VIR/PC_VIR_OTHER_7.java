...
public class PC_VIR_OTHER_7 extends AppCompatActivity {
    ...
    private  int PC_VIR_7_counter_PASS=0;
    private  int PC_VIR_7_counter_FAIL=0;
    ...
    public  void insert_offline(){
        try {
            ...
            if(get_rd1.equalsIgnoreCase("Compliant")){
                PC_VIR_7_counter_PASS++;
            }
            else if (get_rd1.equalsIgnoreCase("Non-Compliant")){
                PC_VIR_7_counter_FAIL++;
            }
        ...
        try {
            ...
            if(get_rd2.equalsIgnoreCase("Compliant")){
                PC_VIR_7_counter_PASS++;
            }
            else if (get_rd2.equalsIgnoreCase("Non-Compliant")){
                PC_VIR_7_counter_FAIL++;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            if(get_rd3.equalsIgnoreCase("Compliant")){
                PC_VIR_7_counter_PASS++;
            }
            else if (get_rd3.equalsIgnoreCase("Non-Compliant")){
                PC_VIR_7_counter_FAIL++;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            if(get_rd4.equalsIgnoreCase("Compliant")){
                PC_VIR_7_counter_PASS++;
            }
            else if (get_rd4.equalsIgnoreCase("Non-Compliant")){
                PC_VIR_7_counter_FAIL++;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            if(get_rd6.equalsIgnoreCase("Compliant")){
                PC_VIR_7_counter_PASS++;
            }
            else if (get_rd6.equalsIgnoreCase("Non-Compliant")){
                PC_VIR_7_counter_FAIL++;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            if(get_rd7.equalsIgnoreCase("Compliant")){
                PC_VIR_7_counter_PASS++;
            }
            else if (get_rd7.equalsIgnoreCase("Non-Compliant")){
                PC_VIR_7_counter_FAIL++;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            if(get_rd8.equalsIgnoreCase("Compliant")){
                PC_VIR_7_counter_PASS++;
            }
            else if (get_rd8.equalsIgnoreCase("Non-Compliant")){
                PC_VIR_7_counter_FAIL++;
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        Log.e("AASXCVAAE","Pass7 =  " + PC_VIR_7_counter_PASS);
        Log.e("AASXCVAAE","fail7 =  " + PC_VIR_7_counter_FAIL);
        ...
        cv_off.put(db.PASS_CHECK, "" + PC_VIR_7_counter_PASS);
        cv_off.put(db.FAIL_CHECK, "" + PC_VIR_7_counter_FAIL);
    ...
    public void get_offline(String id){
        ...
        Log.e("GGGRRRR","E2"  + id);
        String Query="select * from "+db.PC_VIR_DB_OTHER_7 +" where MAIN_ID = '"+id+"'";
        Cursor cursor = sd.rawQuery(Query, null);
        cursor.moveToFirst();
...
//////////////////////rd1//////////
                if(met1.equalsIgnoreCase("Compliant")){
                    ((RadioButton) main_rd1.getChildAt(0)).setChecked(true);


                }
                else if(met1.equalsIgnoreCase("Non-Compliant")){
...
//////////////////////rd2//////////
                if(met2.equalsIgnoreCase("Compliant")){
                    ((RadioButton) main_rd2.getChildAt(0)).setChecked(true);


                }
                else if(met2.equalsIgnoreCase("Non-Compliant")){
...
//////////////////////rd3//////////
                if(met3.equalsIgnoreCase("Compliant")){
                    ((RadioButton) main_rd3.getChildAt(0)).setChecked(true);


                }
                else if(met3.equalsIgnoreCase("Non-Compliant")){
...
//////////////////////rd4//////////
                if(met4.equalsIgnoreCase("Compliant")){
                    ((RadioButton) main_rd4.getChildAt(0)).setChecked(true);


                }
                else if(met4.equalsIgnoreCase("Non-Compliant")){
...
/////////////////////rd6//////////
                if(met6.equalsIgnoreCase("Compliant")){
                    ((RadioButton) main_rd6.getChildAt(0)).setChecked(true);


                }
                else if(met6.equalsIgnoreCase("Non-Compliant")){
...
/////////////////////rd7//////////
                if(met7.equalsIgnoreCase("Compliant")){
                    ((RadioButton) main_rd7.getChildAt(0)).setChecked(true);


                }
                else if(met7.equalsIgnoreCase("Non-Compliant")){
...
/////////////////////rd8//////////
                if(met8.equalsIgnoreCase("Compliant")){
                    ((RadioButton) main_rd8.getChildAt(0)).setChecked(true);


                }
                else if(met8.equalsIgnoreCase("Non-Compliant")){
