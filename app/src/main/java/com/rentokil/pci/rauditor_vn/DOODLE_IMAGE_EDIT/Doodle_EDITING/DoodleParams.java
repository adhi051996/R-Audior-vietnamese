...
public class DoodleParams implements Parcelable {
    ...
    public String mimageAll;
    public String mkey_id;
    public String met1;
    public String met2;
    public String met3;
    ...
    public static final Creator<DoodleParams> CREATOR = new Creator<DoodleParams>() {
        ...
        public DoodleParams createFromParcel(Parcel in) {
            ...
            params.mimageAll = in.readString();
            params.mkey_id = in.readString();
            params.met1 = in.readString();
            params.met2 = in.readString();
            params.met3 = in.readString();
            params.mcounter = in.readString();
            params.mpage = in.readString();
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(mimageAll);
        dest.writeString(mkey_id);
        dest.writeString(met1);
        dest.writeString(met2);
        dest.writeString(met3);
        dest.writeString(mcounter);
