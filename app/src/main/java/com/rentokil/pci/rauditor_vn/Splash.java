...
//        sd.delete( db.AUDIT_ACCESS_TB, null, null );
       ...
       // Log.e("DDDDDD mail",mail+"");
        String  url="https://rauditor.riflows.com/Android/audit_dashboard.php?user_mail="+mail;
        ...
        VolleyDataRequester.withDefaultHttps( this )
                ...
                .setStringResponseListener( new VolleyDataRequester.StringResponseListener() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Log.e("KKKMMJJJJJS","reponse = "+response);

                        try {

                            jsonObject_get_A = new JSONObject(response);
                            ...
                            if (jsonArray_get_A!=null) {
                                if (jsonArray_get_A.length()!=0) {
                                    for (int i = 0; i < jsonArray_get_A.length(); i++) {
                                        ...
                                        Log.e("KKJJJHHH","access = "+audit_name);
                                ...
                                if (jsonArray_get_B.length()!=0) {
                                    for (int l = 0; l < jsonArray_get_B.length(); l++) {
                                        ...
                                        Log.e("KKJJJHHH","access complete = "+audit_name);
                            ...
                            Log.e("DDDDDDSSVVVV","error = "+e.getMessage());
                            e.printStackTrace();
                        }
                    }
                } )
