...
public class ListViewAdapter_PDF  extends BaseAdapter {
    ...
    private List<com.rentokil.pci.rauditor_vn.Adapter.List_Item_PDF_Methodes> List_Item_PDF_Methodes = null;
    private ArrayList<com.rentokil.pci.rauditor_vn.Adapter.List_Item_PDF_Methodes> arraylist;
    public ListViewAdapter_PDF(Context context, ArrayList<List_Item_PDF_Methodes> List_Item_PDF_Methodes) {
        ...
        this.arraylist = new ArrayList<com.rentokil.pci.rauditor_vn.Adapter.List_Item_PDF_Methodes>();
...
/* //   public int getCount() {
    ...
    public View getView(final int position, View view, final ViewGroup parent) {
        ...
        holder.View_Bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.e("HJJAGAGAFSXX","cus = "+List_Item_PDF_Methodes.get(position).getAudi_name());
    ...
    public void filter(String charText) {
        ...
        if (charText.length() == 0) {
            ...
            for (com.rentokil.pci.rauditor_vn.Adapter.List_Item_PDF_Methodes wp : arraylist) {
