package com.rentokil.pci.rauditor_vn.DOODLE_IMAGE_EDIT.Multiple_Display.Adapter;
...
import com.rentokil.pci.rauditor_vn.DOODLE_IMAGE_EDIT.Multiple_Display.CustomGallery;
...
//        imageLoader.displayImage(item.sdcardPath, holder.imgQueue);
        ...
        Log.e("AAGGXBXBXXXX","item path = "+item.sdcardPath);
