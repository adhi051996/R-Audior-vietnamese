...
public class PTI_Title_Page_1 extends AppCompatActivity {
...
String get_report;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new DatabaseHelper(PTI_Title_Page_1.this);
...
//            Toast.makeText(PTI_Title_Page_1.this,"Gps already enabled",Toast.LENGTH_SHORT).show();
        ...
        if(!hasGPSDevice(PTI_Title_Page_1.this)){
            Toast.makeText(PTI_Title_Page_1.this,"Gps not Supported",Toast.LENGTH_SHORT).show();
        }

        if (!manager.isProviderEnabled(LocationManager.GPS_PROVIDER) && hasGPSDevice(PTI_Title_Page_1.this)) {
            Log.e("keshav","Gps already enabled");
            Toast.makeText(PTI_Title_Page_1.this,"Gps not enabled",Toast.LENGTH_SHORT).show();
            enableLoc();
        }else{
            Log.e("keshav","Gps already enabled");
//            Toast.makeText(PTI_Title_Page_1.this,"Gps already enabled",Toast.LENGTH_SHORT).show();
        ...
        et_report_5 =(com.rentokil.pci.rauditor_vn.CustomEditTextWithBullets) findViewById(R.id.et_report_5);
        ...
        back_title_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(PTI_Title_Page_1.this, Category_Type_Activity.class);
                startActivity(i);
        ...
        getlocations.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                geocoder = new Geocoder(PTI_Title_Page_1.this, Locale.getDefault());
                ...
                try {
                    ...
                    if (ContextCompat.checkSelfPermission(mContext,
                            ...
                            != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(PTI_Title_Page_1.this,
                                new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);

                    } else {

                        gps = new GPSTracker(mContext, PTI_Title_Page_1.this);
    ...
    private void insert_offline(String status){
        ...
        if(check_data(key_id)==0) {
            ...
            sd.insert(db.PTI_TITLE_1, null, cv_off);
            Intent intent = new Intent(getApplicationContext(), PTI_Audit_Page_2.class);
            intent.putExtra("key_id", ""+db.get_last_id_PTI(sd));
            startActivity(intent);
            Log.e("MMMMMMH","last id = "+db.get_last_id_PTI(sd));
        }else {
            Log.e("JJJJJJN","status = "+status);
            sd.update(db.PTI_TITLE_1,  cv_off,"KEY_ID = '" + key_id + "'",null);
            Intent intent = new Intent(getApplicationContext(), PTI_Audit_Page_2.class);
...
//        }else {
//            Log.e("HHHHHH","e3");
//            sd.update(db.PTI_TITLE_1,  cv_off,"KEY_ID = '" + status + "'",null);
//            Intent intent = new Intent(getApplicationContext(), RIID_GPP_INFOR_2.class);
//            intent.putExtra("key_id", "" + key_id);
//            startActivity(intent);
//
...
//        Cursor c5;
//        c5 = sd.rawQuery("Select * from " + db.PTI_TITLE_1, null);
//        c5.moveToFirst();
//
...
//
    ...
    public int get_last_id(){
        Cursor c8;
        c8 = sd.rawQuery("Select * from " + db.PTI_TITLE_1, null);
        c8.moveToLast();
    ...
    public void get_offline(String id){
        ...
        Log.e("GGGRRRR","E2"  + id);
        String Query="select * from "+db.PTI_TITLE_1 +" where KEY_ID = '"+id+"'";
        Cursor cursor = sd.rawQuery(Query, null);
        cursor.moveToFirst();
    ...
    private void enableLoc() {
        ...
        if (googleApiClient == null) {
            googleApiClient = new GoogleApiClient.Builder(PTI_Title_Page_1.this)
                    ...
                    switch (status.getStatusCode()) {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            try {
                                ...
                                status.startResolutionForResult(PTI_Title_Page_1.this, REQUEST_LOCATION);
    ...
    public void EnableRuntimePermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(PTI_Title_Page_1.this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE) && ActivityCompat.shouldShowRequestPermissionRationale(PTI_Title_Page_1.this,
                Manifest.permission.READ_EXTERNAL_STORAGE) && ActivityCompat.shouldShowRequestPermissionRationale(PTI_Title_Page_1.this,
                Manifest.permission.GET_ACCOUNTS)) {

            Toast.makeText(PTI_Title_Page_1.this, "STORAGE and CONTACTS permission allows us to Access the app", Toast.LENGTH_LONG).show();

        } else {

            ActivityCompat.requestPermissions(PTI_Title_Page_1.this, new String[]{
